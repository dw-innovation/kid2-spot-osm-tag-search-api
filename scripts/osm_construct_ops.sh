...
echo enrich the kgs with descriptions from their wiki page
python -m app.kg.construction_ops \
--input_file datasets/osm/osm_enriched_kg_v2.ttl \
--output_file datasets/osm/osm_enriched_kg_v3.ttl \
--additional_values osm_wiki_descriptions